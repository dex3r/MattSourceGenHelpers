...
namespace EasySourceGenerators.Tests.Generators.Helpers;
...
public static class GeneratorTestHelper
{
    ...
    /// </summary>
    public static ImmutableArray<Diagnostic> GetGeneratorOnlyDiagnostics(string source)
    {
        SyntaxTree syntaxTree = CSharpSyntaxTree.ParseText(source);
    ...
    /// </summary>
    public static ImmutableArray<Diagnostic>? GetGeneratorOnlyDiagnosticsWithCompilationReference(string source)
    {
