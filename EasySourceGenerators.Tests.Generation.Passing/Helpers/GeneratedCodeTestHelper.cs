...
internal static class GeneratedCodeTestHelper
{
    ...
    private static string FindProjectDirectory()
    {
        ...
        {
            string projectFilePath = Path.Combine(currentDirectory, "EasySourceGenerators.Tests.Generation.Passing.csproj");
        ...
        throw new DirectoryNotFoundException("Could not locate EasySourceGenerators.Tests.Generation.Passing project directory.");
    }
}
